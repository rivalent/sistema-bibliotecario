...
class UserService:
    ...
    def create(self, name, email):
        try:
            ...
            logging.debug(f"[USER-SERVICE] Create: {new_user.to_json()}")
            return new_user
    ...
    def list_all(self):
        try:
            ...
            logging.debug(f"[USER-SERVICE] Get all: {len(list_users)} users  found")
            return list_users
    ...
    def delete(self, user_id):
        try:
            ...
            logging.debug(f"[USER-SERVICE] Deleted USER ID:{user_id}")
            return True
